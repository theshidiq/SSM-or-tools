...
describe('Staff Migration Utils', () => {
  ...
  describe('hasLocalStorageStaffData', () => {
    ...
    it('should detect period-based staff data', () => {
      ...
      localStorage.setItem('staff-1', JSON.stringify([{ name: 'Test Staff 2' }]));
    ...
    it('should detect legacy staff data', () => {
      localStorage.setItem('staffMembers', JSON.stringify([{ name: 'Legacy Staff' }]));
    ...
    it('should detect injected staff data', () => {
      localStorage.setItem('staff_members_0', JSON.stringify([{ name: 'Injected Staff' }]));
