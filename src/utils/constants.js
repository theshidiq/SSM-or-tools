...
export const JAPANESE_HOLIDAYS = {
  ...
  '2024-02-12': { name: '建国記念の日 振替休日', nameEn: 'National Foundation Day (Observed)' },
  ...
  '2024-05-06': { name: 'みどりの日 振替休日', nameEn: 'Greenery Day (Observed)' },
  ...
  '2024-09-23': { name: '秋分の日 振替休日', nameEn: 'Autumnal Equinox Day (Observed)' },
