...
describe('Optimized Feature Generation Performance', () => {
  ...
  describe('Single Prediction Performance', () => {
    test('should generate features in <50ms per prediction (optimized)', async () => {
      ...
      console.log(`🎯 Optimized feature generation time: ${executionTime.toFixed(1)}ms`);
    ...
    test('should maintain consistent performance across multiple predictions', async () => {
      ...
      console.log(`  Under 50ms: ${measurements.filter(t => t < 50).length}/${iterations}`);
  ...
  describe('Batch Processing Performance', () => {
    test('should process batch predictions efficiently', async () => {
      ...
      for (let staffIndex = 0; staffIndex < mockStaffMembers.length; staffIndex++) {
      ...
      console.log(`🔄 Testing batch processing with ${batchRequests.length} predictions`);
  ...
  describe('Memory and Resource Management', () => {
    ...
    test('should provide accurate cache statistics', async () => {
      ...
      if (cacheStats.optimizedWorker) {
        ...
        expect(typeof cacheStats.optimizedWorker.totalPredictions).toBe('number');
...
describe('Performance Regression Tests', () => {
  test('should maintain performance when processing realistic schedule sizes', async () => {
    ...
    for (let staffIndex = 0; staffIndex < Math.min(20, largeStaffList.length); staffIndex++) {
    ...
    console.log(`🏢 Testing with realistic scale: ${batchRequests.length} predictions`);
