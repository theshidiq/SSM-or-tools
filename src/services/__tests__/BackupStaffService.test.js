...
describe('BackupStaffService', () => {
  ...
  describe('Initialization', () => {
    ...
    test('should build backup maps correctly', async () => {
      ...
      expect(backupService.getStaffBackupAssignments('staff-3')).toEqual(['group-2', 'group-3']);
      expect(backupService.getStaffBackupAssignments('staff-6')).toEqual(['group-1']);
  ...
  describe('Edge Cases', () => {
    ...
    test('should handle inactive staff members', () => {
      ...
      expect(() => {
        backupService.buildBackupMaps(inactiveStaff, mockStaffGroups, backupWithInactive);
      }).not.toThrow();
    });
  ...
  describe('Performance', () => {
    ...
    test('should clear cache when requested', () => {
      ...
      expect(backupService.getStatus().cacheSize).toBeGreaterThan(initialCacheSize);
