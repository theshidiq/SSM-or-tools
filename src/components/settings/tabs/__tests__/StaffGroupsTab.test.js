...
describe('StaffGroupsTab Component', () => {
  ...
  describe('Defensive Array Checks', () => {
    test('handles undefined members array gracefully', async () => {
      ...
      expect(screen.getByText('No staff assigned to this group')).toBeInTheDocument();
    });
  ...
  describe('Validation', () => {
    test('displays validation errors', async () => {
      ...
      await waitFor(() => {
        ...
        expect(screen.getByText('At least one staff group is required')).toBeInTheDocument();
      });
    });
  });
