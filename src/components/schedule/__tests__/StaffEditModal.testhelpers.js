...
export const WS_MESSAGES = {
  STAFF_UPDATE: (staffId, changes) => createWSMessage('STAFF_UPDATE', {
    staffId,
    changes
  }),
  ...
  SYNC_RESPONSE: (staffMembers, version = 1) => createWSMessage('SYNC_RESPONSE', {
    staffMembers,
    version,
    period: 0,
  }),

  CONNECTION_ACK: () => createWSMessage('CONNECTION_ACK', { status: 'connected' }),

  ERROR: (message) => createWSMessage('ERROR', {
    message,
    code: 'TEST_ERROR'
  }),
};
