...
export const monthPeriods = [
  { name: '3月 (March)', start: new Date(2024, 2, 25), end: new Date(2024, 3, 24) },
  { name: '4月 (April)', start: new Date(2024, 3, 25), end: new Date(2024, 4, 24) },
  { name: '5月 (May)', start: new Date(2024, 4, 25), end: new Date(2024, 5, 24) },
  { name: '6月 (June)', start: new Date(2024, 5, 25), end: new Date(2024, 6, 24) },
  { name: '7月 (July)', start: new Date(2024, 6, 25), end: new Date(2024, 7, 24) },
  { name: '8月 (August)', start: new Date(2024, 7, 25), end: new Date(2024, 8, 24) },
  { name: '9月 (September)', start: new Date(2024, 8, 25), end: new Date(2024, 9, 24) },
  { name: '10月 (October)', start: new Date(2024, 9, 25), end: new Date(2024, 10, 24) },
  { name: '11月 (November)', start: new Date(2024, 10, 25), end: new Date(2024, 11, 24) },
  { name: '12月 (December)', start: new Date(2024, 11, 25), end: new Date(2025, 0, 24) },
  { name: '1月 (January)', start: new Date(2025, 0, 25), end: new Date(2025, 1, 24) },
  { name: '2月 (February)', start: new Date(2025, 1, 25), end: new Date(2025, 2, 24) }
];